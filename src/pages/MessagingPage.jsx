...
export default function MessagingPage() {
  ...
  const { unreadCount: unreadTotal, refreshUnread, notificationsEnabled, toggleNotifications } = useMessaging();
            ...
            <div className="msg-sidebar__title-row">
              ...
              >
                {notificationsEnabled ? (
                  ...
                  // Bell-off Icon
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M8.7 3a6 6 0 0 1 9.3 5c0 3.9.9 6.2 1.7 7.5"/>
                    <path d="M6 8c0 6-3 8-3 9h13"/>
                    <path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/>
